										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													...
													<h4>
														Your identity has now been verified! We've updated your
														password to the default password. <br>
													</h4>
												</div>
											</div>
										</div><%session.invalidate(); %>
										<a href="login.jsp" class="btn btn-info btn-fill pull-right">Click
											here to Login</a>
