							...
							<div class="card">
								...
								<div class="content">
									<div class=form-group>
										...
										<form action="faqsUpdate.html" method="post">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label>Input the id: </label> <input type="text" required
												...
												<div class="col-md-6">
													<div class="form-group">
														<label><input type="checkbox" name="fields"
															pattern="[A-Za-z0-9 ]+" title="Letters or numbers only!"
															value="Faqs_Question" checked> Question </label> <input
															type="text" class="form-control" name="Faqs_Question" />
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label><input type="checkbox" name="fields"
															pattern="[A-Za-z0-9 ]+" title="Letters or numbers only!"
															value="Faqs_Answer"> Answer </label> <input type="text"
															class="form-control" name="Faqs_Answer" />
													</div>
												</div>
											</div>
