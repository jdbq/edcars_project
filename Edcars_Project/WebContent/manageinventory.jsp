						...
						<div class="col-md-12">
							<div class="card">
								...
								<div style="overflow-x: auto;">
									<form action="inventoryUD.html" method="post">
										...
										<div class="content">
											<div>
												<a href="insertCar.jsp" class="btn btn-info btn-fill">Add
													New Data</a>
												<!-- <a href="updateCar.jsp" class="btn btn-info btn-fill">Update
													Data</a>
												<button type="submit" class="btn btn-info btn-fill">Delete
													Data</button> -->
												<input type="submit" class="btn btn-info btn-fill" name="action" value="Update Data"/>
												<input type="submit" class="btn btn-info btn-fill" name="action" value="Delete Data"/>
											</div>
										</div>
									</form>
								</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<form action="transactUD.html" method="post">
									<div class="content table-responsive table-full-width">
										<table class="table table-hover table-bordered table-striped">
											<thead>
												<th></th>
									...
									<div class="content">
										<div>
											<a href="insertTransaction.jsp" type="submit"
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<form action="updateSetup.html" method="post">
								<div class="content table-responsive table-full-width">
									<table class="table table-hover table-striped table-bordered">
										...
										<tbody>
											...
											%>
											<tr>
												<td><input type="checkbox" name="clientRecords"
															value=<%=(char) 39 + sets4.getString("DLicense_Number") + (char) 39%>></td>
