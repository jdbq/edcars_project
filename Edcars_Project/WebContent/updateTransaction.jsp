				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="header">
									<h4 class="title">Update Transaction Record</h4>
								</div>
								<div class="content">
									<div class=form-group>
										...
										<form action="transactionUpdate.html" method="post">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label>Input the ID</label> <input type="text"
															pattern="[0-9]+" title="Numbers only!"
															class="form-control" name="id" readonly value="${id}" />
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label><input type="checkbox" name="fields"
															value="totalFee" checked>Total Fee </label> <input
															type="text"
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label><input type="checkbox" name="fields"
															value="Amount">Payment amount </label> <input type="text"
															pattern="(0\.((0[1-9]{1})|([1-9]{1}([0-9]{1})?)))|(([1-9]+[0-9]*)(\.([0-9]{1,2}))?)"
															title="Enter only valid price!" class="form-control"
															name="amount" />
													</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label><input type="checkbox" name="fields"
															value="Type">Payment Type </label> <input type="text"
															pattern="(Cash)|(Cheque)"
															title="Input only Cash or Cheque!" class="form-control"
															name="type" />
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label><input type="checkbox" name="fields"
															value="Car_ID">Car ID</label> <input type="text"
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label><input type="checkbox" name="fields"
															value="DLicense_Number">Driver's License ID </label> <input
															type="text"
