		...
		<div class="sidebar" data-color data-image="assets/img/sidebar.jpg">
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li ><a href="generateTables.html"> <i
							class="pe-7s-note2"></i>
					...
					<li class="active"><a href="faqsResult.html"> <i class="pe-7s-science"></i>
							<p>Manage Website</p>
					</a></li>
				</ul>
			</div>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="header">
									<h4 class="title">Insert FAQ</h4>
								</div>
								<div class="content">
									<div class=form-group>
										<form action="faqsInsert.html" method="post">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label>Question</label> <input type="text" 
															
															required class="form-control" name="faqsQuestion" />
													</div>
												</div>
											</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label>Answer</label> <input type="text"
															...
															required class="form-control" name="faqsAnswer" />
													</div>
												</div>
											</div>
