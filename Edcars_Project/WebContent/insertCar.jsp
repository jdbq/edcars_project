				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="header">
									<h4 class="title">Insert Inventory Record</h4>
								</div>
								<div class="content">
									<div class=form-group>
										<form action="inventoryInsert.html" method="post"
												...
												<div class="col-md-6">
													<div class="form-group">
														<label>car Brand: </label> <input type="text"
															...
															title="Letters only!" name="brand" required />
													</div>
												</div>
											</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label>car model: </label> <input type="text"
															class="form-control" pattern="[A-Za-z ]+"
															title="Letters only!" name="model" required />
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label>car Type: </label><input type="text"
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label>car colour: </label> <input type="text"
															class="form-control" pattern="[A-Za-z ]+"
															title="Letters only!" name=" colour" required />
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label>car Status: </label> <select class="form-control"
												...
												<div class="col-md-6">
													<div class="form-group">
														<label>Motor no: </label> <input type="text"
															...
															class="form-control" name="motorNo" required />
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label>Serial no: </label> <input type="text"
															...
															class="form-control" name="serialNo" required />
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label>File no: </label> <input type="text"
															...
															class="form-control" name="fileNo" required />
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label>C.R. no: </label> <input type="text"
															...
															class="form-control" name="crNo" required />
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label>car Image: </label> <input type="file"
