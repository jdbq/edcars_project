				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="header">
									<h4 class="title">Search Vehicle</h4>
								</div>
								<div class="content">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label>car colour: </label> <input type="text"
															class="form-control" pattern="[A-Za-z]+"
															title="Letters only!" name="Colour" />
													</div>
												</div>
											</div>
